...
import FacultyHeader from './AdminHeaderExam';
...
class AdminCreateExam extends Component {
    constructor(props) {
        super(props);
        this.state = {
            rows: "",
        ...
        if (this.state.uploadedFlag) {
            displayUploadedData.push(
                <div>
                    ...
                    <center><Button color="success primary" onClick={() => this.createExam()} size="lg" >Create Exam</Button></center>
