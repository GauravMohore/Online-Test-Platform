...
class FeaturedInfo extends Component {
  ...
  render() {
    const checking = this.state.exams;
    // console.log(this.state.students)
    var students = this.state.students.length;
    var pending = 0;
    var completed = 0;
      ...
      <>
        <div className="featured">
          <div className="featuredItem">
            <span className="featuredTitle">Created</span>
            <div className="featuredMoneyContainer">
              <Box sx={{ position: "relative", display: "inline-flex" }}>
                <CircularProgress
                  ...
                  size="10rem"
                  variant="determinate"
                  value={this.state.exams.length * 10}
                />
                <Box
                  sx={{
                    mx: "auto",
              ...
              {/* <span className="featuredMoney">{this.state.exams.length}</span> */}
          ...
          <div className="featuredItem">
            ...
            <span className="featuredSub">Total Pending </span>
          </div>
          <div className="featuredItem">
            ...
            <span className="featuredSub">Total Completed </span>
          </div>
          <div className="featuredItem">
            ...
            <span className="featuredSub">Total Student</span>
          </div>
        </div>
      </>
    );
